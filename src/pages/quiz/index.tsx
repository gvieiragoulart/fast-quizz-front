...
import { useQuizQuestions, useSubmitQuiz } from "@/hooks/use-api"
import type {
    Answer,
    Question,
    QuestionOption,
...
function QuizPage() {
    ...
    const handleSubmit = async () => {
        ...
        if (answers.length !== questions.length) {
            alert("Por favor, responda todas as questoes antes de enviar.")
            return
        }
        ...
        try {
            const detailedAnswers = answers.map((a) => {
                const question = questions.find((q) => q.id === a.questionId) as
                    | Question
                    | undefined
            ...
            const correctCount = detailedAnswers.filter(
                (d) => d.isCorrect,
            ).length
            ...
            try {
                ...
                if (
                    ...
                    ("correctAnswers" in response || "score" in response)
                ) {
            ...
            <div className="min-h-screen flex items-center justify-center px-4">
                <div className="text-center space-y-4">
                    <Alert variant="destructive" className="max-w-sm">
                        <AlertDescription>
                            Falha ao carregar o quiz. Tente novamente.
                        </AlertDescription>
                    </Alert>
            ...
            <div className="container mx-auto max-w-2xl px-4 py-10">
                <div className="mb-6 space-y-2">
                    <div className="flex justify-between text-sm text-muted-foreground">
                        <span>
                            Questao {currentQuestionIndex + 1} de{" "}
                            {questions.length}
                        </span>
